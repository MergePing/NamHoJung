...
### 이은서
#### CSS reset파일 및 피그마 프로토 타입, 프론트엔드
#### 플로팅버튼(주요 기능 : 다크 모드, 스크롤 업) & 손전등 기능
#### 메인 페이지 - 베스트 게시글 노출, 출석체크 로직
#### 소개 페이지
#### 게시판 페이지 - 게시글 카테고리별 정렬 및 즐겨찾기 비동기 DB 연동
#### 게시글 페이지 - 게시글 CRUD 및 무서워요, 안무서워요 이미지 및 숫자 DB연동
#### 게시글 페이지 - 타 사용자의 프로필 이미지 조회 가능
#### 마이페이지 - 사용자 프로필 이미지 업로드 및 저장 구현
#### 이미지 서버 저장 및 경로 DB 저장
#### DB 관리자 - DB 관리
